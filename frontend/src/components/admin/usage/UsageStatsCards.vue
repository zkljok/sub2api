    ...
    <div class="card p-4 flex items-center gap-3">
      ...
      <div>
        ...
        <p class="flex flex-wrap items-center gap-x-1 text-xs text-gray-500">
          ...
          <span>/</span>
          <span
            class="group relative inline-flex cursor-help items-center gap-1 rounded-full bg-amber-50 px-2 py-0.5 text-amber-700 dark:bg-amber-900/20 dark:text-amber-400"
            tabindex="0"
          >
            <svg
